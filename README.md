This project is a collection of three beginner-friendly Python applications that demonstrate the use of basic programming concepts such as conditionals, loops, functions, and user input handling.
